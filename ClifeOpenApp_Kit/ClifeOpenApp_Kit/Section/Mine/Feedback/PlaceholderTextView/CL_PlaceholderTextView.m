...
@interface CL_PlaceholderTextView()<UITextViewDelegate>
...
@end
@implementation CL_PlaceholderTextView
...
-(void)DidChange:(NSNotification*)noti{
    ...
    if (_eventBlock && self.text.length > self.maxTextLength) {
        ...
        void (^limint)(CL_PlaceholderTextView*text) =_eventBlock;
...
-(void)textViewBeginNoti:(NSNotification*)noti{
    ...
    if (_BeginBlock) {
        void(^begin)(CL_PlaceholderTextView*text)=_BeginBlock;
        begin(self);
    }
}
-(void)textViewEndNoti:(NSNotification*)noti{
    ...
    if (_EndBlock) {
        void(^end)(CL_PlaceholderTextView*text)=_EndBlock;
        end(self);
    }
}
...
-(void)addTextViewBeginEvent:(void (^)(CL_PlaceholderTextView *))begin{
    
    _BeginBlock=begin;
}

-(void)addTextViewEndEvent:(void (^)(CL_PlaceholderTextView *))End{
    _EndBlock=End;
}
