...
@interface HETSystemMessageVC ()<UITableViewDataSource,UITableViewDelegate>
/** 消息类型列表 **/
...
@implementation HETSystemMessageVC
...
{
    // 1.中间标题
    self.navigationItem.title = MessageCenterListNavTitle;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SystemMessageCell *cell = [SystemMessageCell initWithTableView:tableView];
    [cell setDeleteBtnClick:^{
...
{
    WEAKSELF
    self.messageTypeTableView.mj_header = [HETComRefreshHeader headerWithRefreshingBlock:^{
