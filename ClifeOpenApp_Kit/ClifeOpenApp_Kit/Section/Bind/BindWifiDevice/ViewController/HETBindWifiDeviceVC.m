...
@implementation HETBindWifiDeviceVC
...
- (void)searchDevice
{
    ...
    [[HETWIFIBindBusiness sharedInstance] startSmartLinkBindDeviceWithProductId:[NSString stringWithFormat:@"%@",self.device.productId]
