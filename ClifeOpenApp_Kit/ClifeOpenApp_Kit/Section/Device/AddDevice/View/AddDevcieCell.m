...
@interface AddDevcieCell ()
@property (nonatomic,strong) UIImageView                                       *deviceImageView;
@property (nonatomic,strong) UILabel                                           *deviceNameLabel;
@end
@implementation AddDevcieCell

+ (instancetype)initWithTableView:(UITableView *)tabbleView
{
    static NSString *ID = @"AddDevcieCell";
    AddDevcieCell *cell = [tabbleView dequeueReusableCellWithIdentifier:ID];
    if (!cell)
    {
        cell = [[AddDevcieCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
