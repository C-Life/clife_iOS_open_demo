...
- (void)configBindingUI
{
    ...
    self.productCodeLable.text = @"HANCC-HF";
...
- (void)configBindSuccessUI
{
    ...
    self.bindSuccessLable.text = @"绑定成功";
