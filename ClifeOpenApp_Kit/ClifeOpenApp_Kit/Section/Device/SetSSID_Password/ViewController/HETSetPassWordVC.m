...
- (void) turnToScanDeviceVCAction
{
    ...
    HETSearchDeviceVC *searchVC = [HETSearchDeviceVC new];
    searchVC.productId = self.productId;
    searchVC.ssid = self.wifiNameField.text;
    searchVC.password = self.passwordField.text;
    searchVC.bindType = 1;
...
{
    [self.view endEditing:YES];
    [self.navigationController pushViewController:[HETChangeWIFIVC new] animated:YES];
}
