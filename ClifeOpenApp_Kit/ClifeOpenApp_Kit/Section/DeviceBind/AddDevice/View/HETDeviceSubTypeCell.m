...
@interface HETDeviceSubTypeCell ()
@property (nonatomic,strong) UIImageView                                       *deviceImageView;
@property (nonatomic,strong) UILabel                                           *deviceNameLabel;
@property (nonatomic,strong) UILabel                                           *macNameLabel;
@end

@implementation HETDeviceSubTypeCell

+ (instancetype)initWithTableView:(UITableView *)tabbleView
{
    static NSString *ID = @"HETDeviceSubTypeCell";
    HETDeviceSubTypeCell *cell = [tabbleView dequeueReusableCellWithIdentifier:ID];
    if (!cell)
    {
        cell = [[HETDeviceSubTypeCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
