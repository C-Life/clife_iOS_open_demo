...
- (void)createSubView
{
    ...
    hotDevciceLabel.backgroundColor = UIColorFromRGB(0xef6fafd);
    hotDevciceLabel.textAlignment = NSTextAlignmentLeft;
//    hotDevciceLabel.textColor = [UIColor colorFromHexRGB:@"ef6fafd"];
    hotDevciceLabel.text = DeviceBindWithType;
    hotDevciceLabel.font = [UIFont fontWithName:@"SourceHanSansCH-Regular" size:13];
