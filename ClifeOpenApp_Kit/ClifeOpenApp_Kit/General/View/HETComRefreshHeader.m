//
//  CBComRefreshHeader.m
//  CBeauty
//
//  Created by leoo on 2018/3/1.
//  Copyright © 2018年 wff. All rights reserved.
//

#import "HETComRefreshHeader.h"

@interface HETComRefreshHeader()
@property (nonatomic, strong) LOTAnimationView *laAnimation;
@end

@implementation HETComRefreshHeader
...
- (void)placeSubviews
{
    ...
    self.laAnimation.frame = CGRectMake(0, 0, 30.0, 15.0);
